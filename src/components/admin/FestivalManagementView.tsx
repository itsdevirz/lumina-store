...
export const FestivalManagementView: React.FC<FestivalManagementViewProps> = ({
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 font-sans text-slate-100">
      {/* View Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-xl bg-gradient-to-tr from-rose-600 to-pink-500 text-white shadow-lg shadow-rose-600/20">
              <Sparkles className="w-5 h-5" />
            </div>
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
              مدیریت جشنواره‌ها و کمپین‌های تخفیفی
            </h1>
          </div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white text-xs font-black shadow-lg shadow-rose-600/30 transition-all cursor-pointer"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <p className="text-[11px] text-emerald-500 mt-1">نمایش زنده در صفحه اصلی</p>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <p className="text-[11px] text-slate-400 mt-1">ثبت‌شده در دیتابیس</p>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <p className="text-[11px] text-rose-500 mt-1">کالای منتخب جشنواره</p>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <p className="text-[11px] text-amber-500 mt-1">کوپن‌های فعال کمپین</p>
        </div>
      </div>

      {/* Filters & Search Toolbar */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-3.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pr-10 pl-4 py-2 text-xs rounded-xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500"
          />
        </div>
      ...
      {/* Festival List */}
      {isLoading ? (
        <div className="p-12 text-center text-slate-400 text-xs">در حال بارگذاری اطلاعات جشنواره‌ها...</div>
        ...
        <div className="p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-900 dark:text-white">هیچ جشنواره‌ای یافت نشد</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {filteredFestivals.map(fest => {
            ...
            return (
              <div
                key={fest.id}
                className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-5 sm:p-6 space-y-4 shadow-xs relative overflow-hidden transition-all hover:border-rose-500/40"
              >
                {/* Decorative Accent Glow */}
                <div
                  className={`absolute -top-10 -left-10 w-40 h-40 rounded-full blur-3xl opacity-15 pointer-events-none ${
                    fest.themeColor === 'rose'
                      ? 'bg-rose-500'
                      : fest.themeColor === 'emerald'
                      ? 'bg-emerald-500'
                      : fest.themeColor === 'amber'
                      ? 'bg-amber-500'
                      : fest.themeColor === 'purple'
                      ? 'bg-purple-500'
                      : 'bg-indigo-500'
                  }`}
                />
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-[10px]">
                        اولویت: {fest.priority || 10}
                      </span>
                      {fest.badgeText && (
                        <span className="px-2 py-0.5 rounded-full bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 text-[10px] font-bold">
                          {fest.badgeText}
                        </span>
                      )}
                    </div>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors cursor-pointer shrink-0 ${
                      fest.isActive ? 'bg-emerald-500' : 'bg-slate-300 dark:bg-slate-700'
                    }`}
                ...
                {/* Date & Time Duration */}
                <div className="grid grid-cols-2 gap-2 text-xs p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-800">
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  {fest.couponCode && (
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 font-mono font-bold text-[11px] hover:bg-indigo-100 dark:hover:bg-indigo-900 transition-colors cursor-pointer"
                    >
                ...
                {fest.products && fest.products.length > 0 && (
                  <div className="flex items-center gap-2 overflow-x-auto py-1">
                    {fest.products.slice(0, 4).map((p, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2 p-1.5 pr-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/90 text-[11px] shrink-0"
                      >
                        <img
                        ...
                        <div className="flex flex-col">
                          <span className="text-slate-900 dark:text-slate-200 font-medium line-clamp-1 max-w-[120px]">
                            {p.nameFa || p.name}
                          </span>
                ...
                <div className="flex items-center justify-between gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/60 text-rose-600 dark:text-rose-400 text-xs font-bold transition-colors cursor-pointer"
                    >
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 space-y-5 shadow-2xl text-slate-900 dark:text-white">
            <div className="flex items-center gap-3 text-rose-500">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">این عملیات قابل بازگشت نیست.</p>
              </div>
            </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
          <div className="w-full max-w-4xl max-h-[90vh] rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl flex flex-col overflow-hidden text-slate-900 dark:text-white">
            {/* Modal Header */}
            ...
            <div className="flex items-center gap-2 px-6 pt-4 border-b border-slate-200 dark:border-slate-800 overflow-x-auto shrink-0">
              {[
            ...
            <form onSubmit={handleSaveFestival} className="p-6 space-y-6 overflow-y-auto flex-1 text-xs">
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="font-bold text-slate-700 dark:text-slate-300">
                        عنوان جشنواره <span className="text-rose-500">*</span>
                      </label>
                      <input
                        type="text"
                        value={title}
                        ...
                        required
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500 text-xs"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500 text-xs text-left"
                      />
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/40 space-y-3">
                    <div className="flex items-center justify-between">
                      <label className="font-bold text-rose-700 dark:text-rose-300 flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500 text-xs"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500 text-xs"
                      >
                        <option value="rose">رز / قرمز فستیوال (Rose)</option>
                        <option value="indigo">نیلی مدرن (Indigo)</option>
                        <option value="emerald">زمردی بهاره (Emerald)</option>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden focus:border-rose-500 text-xs"
                      />
                      <p className="text-[10px] text-slate-400">عددهای بالاتر اولویت بیشتری در صفحه اصلی دارند.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                    <div>
                      <span className="font-bold text-slate-900 dark:text-white block">وضعیت فعال بودن جشنواره</span>
              ...
              {activeModalTab === 'schedule' && (
                <div className="space-y-5">
                  <div className="p-4 rounded-2xl bg-indigo-50/60 dark:bg-indigo-950/30 border border-indigo-200/60 dark:border-indigo-800/40 space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-indigo-700 dark:text-indigo-300">الگوهای زمان‌بندی آماده:</span>
                      <span className="text-[11px] text-slate-400">تنظیم خودکار بازه زمانی</span>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      <button
                        type="button"
                        onClick={() => applyPreset(1)}
                        className="px-3 py-1.5 rounded-xl bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 font-bold border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-50 cursor-pointer"
                      >
                        ⚡ ۲۴ ساعته (فلش سیل)
                      </button>
                      <button
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 space-y-2">
                    <h4 className="font-bold text-slate-900 dark:text-white">قوانین سیستم زمان‌بندی:</h4>
                    <ul className="list-disc pr-5 space-y-1 text-slate-500 dark:text-slate-400 text-[11px]">
              ...
              {activeModalTab === 'products' && (
                <div className="space-y-5">
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pr-9 pl-3 py-2 text-xs rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden"
                      />
                    </div>
                    <select
                      value={selectedCategory}
                      onChange={e => setSelectedCategory(e.target.value)}
                      className="px-3 py-2 text-xs rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white outline-hidden"
                    >
                  ...
                  <div className="space-y-3">
                    <h4 className="font-bold text-slate-900 dark:text-white flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-slate-400">تخفیف و موجودی جشنواره را ویرایش کنید</span>
                    </h4>

                    {selectedProducts.length === 0 ? (
                      <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-dashed border-slate-300 dark:border-slate-700 text-center text-slate-400">
                      ...
                      <div className="space-y-2.5 max-h-64 overflow-y-auto pr-1">
                        {selectedProducts.map(p => (
                          <div
                            key={p.productId}
                            className="p-3 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3"
                          >
                            <div className="flex items-center gap-2.5">
                              <img
                              ...
                              />
                              <div>
                                <span className="font-bold text-slate-900 dark:text-white block line-clamp-1 max-w-[200px]">
                                  {p.nameFa || p.name}
                                </span>
                                <span className="text-[11px] text-slate-400">
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                              ...
                              <div className="flex items-center gap-1">
                                <label className="text-[10px] text-slate-400">درصد تخفیف:</label>
                                <div className="relative w-16">
                                  <input
                                    ...
                                    className="w-full px-2 py-1 text-center font-bold text-rose-500 rounded-lg bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-900 text-xs"
                                  />
                                </div>
                              ...
                              {/* Discounted Price */}
                              <div className="flex items-center gap-1">
                                <label className="text-[10px] text-slate-400">قیمت جشنواره:</label>
                                <input
                                  type="number"
                                  step="10000"
                                  value={p.discountedPrice}
                                  onChange={e => handleUpdateProductPrice(p.productId, Number(e.target.value))}
                                  className="w-28 px-2 py-1 text-left font-mono font-bold rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs"
                                />
                              </div>

                              {/* Festival Stock */}
                              <div className="flex items-center gap-1">
                                <label className="text-[10px] text-slate-400">موجودی کمپین:</label>
                                <input
                                  type="number"
                                  min="1"
                                  value={p.festivalStock}
                                  onChange={e => handleUpdateProductStock(p.productId, Number(e.target.value))}
                                  className="w-14 px-2 py-1 text-center font-bold rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs"
                                />
                              </div>
                  ...
                  <div className="space-y-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                    <h4 className="font-bold text-slate-900 dark:text-white">افزودن محصولات فروشگاه به این جشنواره:</h4>
                          ...
                          return (
                            <button
                              ...
                              className={`p-2.5 rounded-xl border flex items-center justify-between text-right transition-all cursor-pointer ${
                                isSelected
                                  ? 'bg-rose-50/80 dark:bg-rose-950/30 border-rose-500/80 text-rose-700 dark:text-rose-300'
                                  : 'bg-white dark:bg-slate-800/80 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white hover:border-slate-400'
                              }`}
                            >
                              <div className="flex items-center gap-2">
                                <img
                                ...
                                <div>
                                  ...
                                  <span className="text-[10px] text-slate-400">{formatToman(prod.price)}</span>
                                </div>
                              </div>
                              <div
                                className={`w-5 h-5 rounded-full flex items-center justify-center ${
                                  isSelected ? 'bg-rose-600 text-white' : 'border border-slate-400'
                                }`}
                              >
                ...
                <div className="space-y-5">
                  <div className="p-4 rounded-2xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200/60 dark:border-amber-900/40 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div className="space-y-1">
                        <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">کد کوپن</label>
                        <input
                          type="text"
                          value={newCouponCode}
                          onChange={e => setNewCouponCode(e.target.value)}
                          placeholder="مثال: FESTIVAL2026"
                          className="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white uppercase font-mono text-xs"
                        />
                      </div>

                      <div className="space-y-1">
                        <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">نوع تخفیف</label>
                        <select
                          value={newCouponType}
                      ...
                      <div className="space-y-1">
                        <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                      <div className="space-y-1">
                        <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">حداقل خرید (تومان)</label>
                        <input
                          type="number"
                      ...
                      {newCouponType === 'percent' && (
                        <div className="space-y-1">
                          <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">سقف تخفیف (تومان)</label>
                          <input
                            type="number"
                      ...
                      <div className="space-y-1">
                        <label className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">تعداد مجاز استفاده</label>
                        <input
                          type="number"
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-bold text-xs shadow-xs cursor-pointer"
                    >
                  ...
                  <div className="space-y-2.5">
                    <h4 className="font-bold text-slate-900 dark:text-white">کدهای تخفیف متصل به این جشنواره:</h4>
                    {festivalCoupons.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {festivalCoupons.map(c => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <span className="px-3 py-1 rounded-xl bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 font-mono font-bold text-xs">
                                {c.code}
                              </span>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-800">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold hover:bg-slate-200 cursor-pointer"
                >
                  انصراف
                </button>
                ...
                <div className="flex items-center gap-3">
                  {activeModalTab !== 'coupons' && (
                    <button
                      ...
                      className="px-4 py-2.5 rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-white font-bold cursor-pointer"
                    >
                      مرحله بعد
                    </button>
                  )}
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white font-bold shadow-lg shadow-rose-600/30 cursor-pointer"
                  >
