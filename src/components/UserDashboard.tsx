    ...
    return (
      <div className="py-16">
        <div className="max-w-md mx-auto px-4 text-center">
          <div className="w-16 h-16 rounded-3xl bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mx-auto mb-4 shadow-sm">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-lg shadow-indigo-600/25 transition-all"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 font-bold text-xs hover:bg-slate-50 dark:hover:bg-slate-800 transition-all"
            >
              <span>{lang === 'fa' ? 'ایجاد حساب کاربری جدید' : 'Create New Account'}</span>
            </button>
            <button
              onClick={quickDemoLogin}
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-indigo-200 dark:border-indigo-900/50 bg-indigo-50/50 dark:bg-indigo-950/30 text-indigo-700 dark:text-indigo-300 font-bold text-xs hover:bg-indigo-100 transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden flex items-center gap-2 overflow-x-auto pb-4 mb-4 no-scrollbar">
          ...
          >
            ...
            <span className="text-[10px] bg-slate-200/60 dark:bg-slate-800 px-1.5 py-0.2 rounded-full">
              {userOrders.length}
            </span>
          </button>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 shadow-xs space-y-6">
              {/* User Profile Card */}
              <div className="flex items-center gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
                ...
                >
                  <img
                    ...
                    className="w-16 h-16 rounded-2xl object-cover ring-2 ring-indigo-500/20 shadow-xs group-hover:opacity-85 transition-opacity"
                  />
                  ...
                  <span className="absolute -bottom-1 -right-1 p-1 rounded-lg bg-indigo-600 text-white shadow-2xs">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="inline-block mt-1 text-[10px] bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 font-bold px-2 py-0.5 rounded-full">
              ...
              <div className="space-y-1">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                >
                  <div className="flex items-center gap-2.5">
                    <Heart className="w-4 h-4" />
                    <span>{lang === 'fa' ? 'کالاهای مورد علاقه' : 'Wishlist'}</span>
                  </div>
                  <span className="text-[11px] bg-rose-50 dark:bg-rose-950 text-rose-600 px-2 py-0.5 rounded-full font-bold">
                    {wishlist.length}
                  </span>
                </button>
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
                  <button
                    onClick={logout}
                    className="w-full flex items-center gap-2.5 p-3 rounded-xl text-xs font-bold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors"
                  >
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {activeSection === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 space-y-5">
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between sm:justify-end gap-3">
                                  ...
                                  <button
                                    ...
                                    className="px-2.5 py-1 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-[11px] font-semibold text-indigo-600 dark:text-indigo-400 hover:bg-slate-50 cursor-pointer"
                                  >
                  ...
                  <div>
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 text-[11px] font-bold transition-all disabled:opacity-50 cursor-pointer"
                ...
                <div className="space-y-6">
                  {userOrders
                    ...
                    .map(order => (
                      <div
                        key={order.id}
                        className="rounded-3xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 overflow-hidden space-y-4 p-5 sm:p-6 transition-all hover:border-slate-300 dark:hover:border-slate-700"
                      >
                        {/* Order Header Meta */}
            ...
            {activeSection === 'addresses' && (
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 space-y-4">
                ...
                {isAddingAddress && (
                  <form onSubmit={handleCreateAddress} className="p-4 rounded-2xl bg-indigo-50/50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 mb-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-center">
                      ...
                      <button
                        type="submit"
                        className="py-2.5 px-4 rounded-xl bg-indigo-600 text-white font-bold text-xs hover:bg-indigo-700 transition-colors"
                      >
            ...
            {activeSection === 'profile' && (
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 space-y-8">
                <div>
                  ...
                  <form onSubmit={handleSaveProfile} className="space-y-4 max-w-lg">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white outline-hidden focus:ring-2 focus:ring-indigo-500"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="flex items-center gap-2 py-2.5 px-5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-600/20 transition-all cursor-pointer"
                    >
                ...
                <div className="pt-6 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    >
                      <div className="w-9 h-9 rounded-xl bg-indigo-100 dark:bg-indigo-900/60 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-3 shadow-xs">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                        {lang === 'fa'
                          ? 'مشکی ملایم با هایلایت‌های ایندیگو بدون خستگی چشم'
                          : 'Ergonomic deep slate with indigo accents for low eye strain'}
                      </p>
                    </button>
