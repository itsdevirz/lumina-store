...
export const defaultEnhancedCategories: Category[] = [
  ...
  },
  {
    ...
    slug: 'apparel-men',
    icon: 'Shirt',
    image: 'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=800&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    icon: 'Shirt',
    image: 'https://images.unsplash.com/photo-1564257631407-4deb1f99d992?w=800&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    slug: 'apparel-kids',
    icon: 'Shirt',
    image: 'https://images.unsplash.com/photo-1519457431-44ccd64a579b?w=800&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    slug: 'audio-speakers',
    icon: 'Headphones',
    image: 'https://images.unsplash.com/photo-1545454675-3531b543be5d?w=800&q=80&auto=format&fit=crop',
...
const initialUsers = [
  ...
  },
  {
    ...
    phone: '۰۹۱۵۰۰۰۱۱۲۲',
    avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=300&q=80&auto=format&fit=crop',
    role: 'regular',
...
const initialFestivals: Festival[] = [
  {
    ...
    bannerImage: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&q=80&auto=format&fit=crop',
    products: [
      {
        productId: 'lum-01',
...
class DatabaseManager {
  ...
  public createFestival(data: Partial<Festival>): Festival {
    ...
    const newFestival: Festival = {
      ...
      bannerImage: data.bannerImage || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&q=80&auto=format&fit=crop',
